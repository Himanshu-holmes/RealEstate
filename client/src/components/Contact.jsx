    ...
    <>
      {landlord && (
        <div className=" flex flex-col gap-2">
          ...
          <textarea name="message" id="message"cols={50}  rows="2" value={message} className=' w-full border p-3 rounded-lg mt-2' placeholder="Enter your Message here ...." onChange={onChange}></textarea>
